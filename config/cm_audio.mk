...
ALARM_PATH := vendor/custom_rom/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/custom_rom/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/custom_rom/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/custom_rom/prebuilt/common/media/audio/ui
